...
public class FrmSortApp extends javax.swing.JFrame {
    ...
    MongoCollection<Document> Data = new MongoConnection().obtenerDB().getCollection("Numbers");
    ...
    public FrmSortApp() {
        ...
        table.addColumn("ID");
        table.addColumn("NUMBER 1");
        table.addColumn("NUMBER 2");
        table.addColumn("NUMBER 3");
        table.addColumn("NUMBER 4");
    ...
    private void initComponents() {
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NUMBER 1", "NUMBER 2", "NUMBER 3", "NUMBER 4"
            }
        ) {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtNumber1, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        data.put("Number 1", txtNumber1.getText());
        data.put("Number 2", txtNumber2.getText());
        data.put("Number 3", txtNumber3.getText());
        data.put("Number 4", txtNumber4.getText());
        data.put("SIZE", txtSize.getText());
        data.put("Sort",txtSort.getText());
