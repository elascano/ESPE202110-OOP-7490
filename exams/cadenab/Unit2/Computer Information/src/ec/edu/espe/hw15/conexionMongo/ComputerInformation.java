 ...
 */
public class ComputerInformation extends javax.swing.JFrame {
DB db;
DBCollection products;
 BasicDBObject document = new BasicDBObject();
     ...
     */
    public ComputerInformation() throws UnknownHostException{
    ...
    try {
        ...
        Logger.getLogger(ComputerInformation.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("COMPUTER INFORMATION");
...
products.update(document,documentN);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComputerInformation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ComputerInformation().setVisible(true);
                } catch (UnknownHostException ex) {
                    Logger.getLogger(ComputerInformation.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
