...
public class FrmComputer extends javax.swing.JFrame {
    ...
    MongoCollection<org.bson.Document> Computer = new Connection().obtenerDB().getCollection("Computer");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("COMPUTER INFORMATION");
        ...
        txtBrand.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Apple", "Dell", "Lenovo", "HP", "Asus", "Acer", "Alienware", "Razer", "Toshiba", "Samsung", "Other", " " }));
        ...
        txtTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Serial Number", "Brand", "Model", "RAM (GB)", "Storage", "Price"
            }
        ));
    ...
    private void txtUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtUploadActionPerformed
        int line = txtTable.getSelectedRow();
        if (line == -1) {
            JOptionPane.showMessageDialog(this, "Error, Select the row to update");
            return;
        }
        String idUpload = txtTable.getValueAt(line, 0).toString();
        int answer = JOptionPane.showConfirmDialog(this, "Are you sure to update the information" + idUpload);
        if (answer == JOptionPane.OK_OPTION) {
            Upload upload = new Upload(this, true, (JTable) Computer, idUpload);
