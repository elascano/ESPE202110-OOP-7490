...
import ec.edu.espe.book.model.Connection;
import ec.edu.espe.book.model.Upload;
 ...
 * @author Angel Guaman
 */
public class FrmContacts1 extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtCellPhone, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(txtHobby, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        int line = tblContacts.getSelectedRow();
        if(line == -1){
            JOptionPane.showMessageDialog(this, "Error, select the contact you want to delete");
            return;
        }
        String idRemove = tblContacts.getValueAt(line, 0).toString();
        int answer = JOptionPane.showConfirmDialog(this, "Want to remove this ID?"+ idRemove);
        if(answer == JOptionPane.OK_OPTION){
            boolean answerDelete = Delete(idRemove);
            if(answerDelete==true){
                mostrar();
                JOptionPane.showMessageDialog(this, "It was removed correctly");
            }else{
    ...
    private void btnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUploadActionPerformed
        ...
        String idUpload = tblContacts.getValueAt(line, 0).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmContacts1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmContacts1().setVisible(true);
            }
        });
    }
    public void mostrar(){
