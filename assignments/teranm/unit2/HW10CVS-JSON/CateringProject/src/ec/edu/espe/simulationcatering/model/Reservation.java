...
public class Reservation {
   ...
   @Override
    public String toString() {
        return "Reservation Data--->{" + "Client name is= " + getClientName() + ", phone to client is= " + getPhone() + ", name event is= " + getEventName() + ", date is= " + getDate() + ", Payment Method is= " + getPaymentMethod() + ", specs is= " + getSpecs() + '}';
    }
