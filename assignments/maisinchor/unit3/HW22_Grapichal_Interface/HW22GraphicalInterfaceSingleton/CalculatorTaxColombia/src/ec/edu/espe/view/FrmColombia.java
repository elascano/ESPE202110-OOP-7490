 ...
 */
public class FrmColombia extends javax.swing.JFrame {

    /**
     * Creates new form FrmColombia
     */
    public FrmColombia() {
        initComponents();
    }
    ...
    private void btncalcuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncalcuActionPerformed
       double priceTotalTaxes;
        double objectTax;
        double taxValueInColombia;
        double sale;
       
        sale = Double.parseDouble(txt_price.getText());
        taxValueInColombia = Double.parseDouble(txt_tax.getText());
        objectTax = sale * (100/taxValueInColombia);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmColombia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmColombia().setVisible(true);
            }
        });
    }
