...
public class allApartments extends javax.swing.JFrame {
...
public void view(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(allApartments.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new allApartments().setVisible(true);
            }
        });
    }
