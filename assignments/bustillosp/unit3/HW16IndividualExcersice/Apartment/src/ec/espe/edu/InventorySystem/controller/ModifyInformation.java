...
//ESTA CLSE VA EN EL PAQUETE DE VIEW
...
public class ModifyInformation extends javax.swing.JFrame {
    ...
    public ModifyInformation() {
        ...
        tabla.addColumn("ID CLOUD");tabla.addColumn("ID ");tabla.addColumn("CAPCITY");
        tabla.addColumn("SIZE");tabla.addColumn("PRICE");tabla.addColumn("CONDITION");
        tabla.addColumn("DATE");tabla.addColumn("LOCATION");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyInformation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
