...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/edu/espe/InventorySystem/icons/login_gov_icon_146024 (1).png"))); // NOI18N

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 8)); // NOI18N
        jLabel5.setText("@PSBM");

        jLabel6.setText("User: PSBM");

        jLabel7.setText("Password: 1751375971");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(usuario.isEmpty() || paswd.isEmpty()){
            ...
            if(usuario.equals("PSBM")&& paswd.equals("1751375971")){
                JOptionPane.showMessageDialog(null,"Hello");
                Apartment SP = new Apartment();
                SP.setVisible(true);
                this.dispose();
