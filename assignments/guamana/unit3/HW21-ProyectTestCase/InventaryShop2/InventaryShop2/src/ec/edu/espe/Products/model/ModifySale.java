...
public class ModifySale extends javax.swing.JFrame {
    ...
    public ModifySale() {
        ...
        tabla2.addColumn("ID CLOUD");tabla2.addColumn("ID PRODUCT");tabla2.addColumn("QUANTITY");
        tabla2.addColumn("SOLD PRICE");tabla2.addColumn("TOTAL SOLD");tabla2.addColumn("DATE SOLD");
    }
    ...
    private void initComponents() {
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/upload.png"))); // NOI18N
    ...
    int renglon = tblSales.getSelectedRow();
        ...
        if(answer == JOptionPane.OK_OPTION){
            SaleUpload saleUpload = new SaleUpload(this,true,MongoConnection, idUploadSale);
