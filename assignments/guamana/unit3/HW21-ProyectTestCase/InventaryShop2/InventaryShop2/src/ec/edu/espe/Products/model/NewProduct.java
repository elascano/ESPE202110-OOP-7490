...
public class NewProduct extends javax.swing.JFrame {
    ...
    public NewProduct() {
        ...
        tabla.addColumn("ID CLOUD");tabla.addColumn("ID PRODUCT");tabla.addColumn("PRODUCT NAME");tabla.addColumn("QUANTITY");
        tabla.addColumn("PRICE");tabla.addColumn("AVAILABILITY");tabla.addColumn("EXPIRATION DATE");
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(answer == JOptionPane.OK_OPTION){
            NewProductUpload upload = new NewProductUpload(this,true, MongoConnection, idUpload);
