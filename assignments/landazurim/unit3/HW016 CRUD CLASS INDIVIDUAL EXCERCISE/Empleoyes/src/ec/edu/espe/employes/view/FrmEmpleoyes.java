...
package ec.edu.espe.employes.view;

import com.mongodb.client.MongoCollection;
import com.mongodb.client.MongoCursor;
import com.mongodb.client.result.DeleteResult;
import ec.edu.espe.employes.model.Upload;
import ec.edu.espe.employes.utils.Connection;
...
public class FrmEmpleoyes extends javax.swing.JFrame {
    ...
    MongoCollection<Document> exercise = new Connection().obtenerDB().getCollection("Empleoyes");
    ...
    public FrmEmpleoyes() {
        ...
        tabla.addColumn("WorkArea");tabla.addColumn("Age");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EMPLEOYES MATEO LANDÁZURI");

        jLabel2.setText("ID");

        jLabel3.setText("NAME");

        jLabel4.setText("WORKAREA");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            data.put("WORKAREA", txtWORKAREA.getText());
            data.put("AGE", Integer.parseInt(txtAGE.getText()));
            data.put("PHONE", Integer.parseInt(txtPHONE.getText()));
