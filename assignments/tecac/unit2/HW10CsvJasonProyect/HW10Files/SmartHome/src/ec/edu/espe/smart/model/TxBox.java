 ...
 * @author Camila
 */
public class TxBox extends Device{
    private int volume;
...
@Override
    ...
    public TxBox(int volume, int channelsQuantity, ArrayList<String> channels, int id, String description, String room, boolean status, int workingData) {
