 ...
 * @author USUARIO
 */
public class FrmRemove extends javax.swing.JFrame {

    /**
     * Creates new form FrmRemove
     */
    public FrmRemove() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRemove.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
