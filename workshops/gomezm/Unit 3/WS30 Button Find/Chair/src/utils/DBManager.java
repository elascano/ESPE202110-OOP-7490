...
public class DBManager {
    ...
    public static void create(String id, String model, String material, String backrest, String price) {
    ...
    public static void update(String id, String idu,String model, String material, String backrest, String price){
        Document filter;
        ...
        documentoUp.put("Model", model);
        documentoUp.put("Material",material);
        documentoUp.put("Backrest",backrest);
