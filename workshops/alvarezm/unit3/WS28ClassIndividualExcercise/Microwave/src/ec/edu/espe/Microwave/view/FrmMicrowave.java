...
import ec.edu.espe.Microwave.model.Microwave;
...
public class FrmMicrowave extends javax.swing.JFrame {
    ...
    MongoCollection<Document> Microwave = new Connection().obtenerDB().getCollection("Microwave");
    ...
    private void BtnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUpdateActionPerformed
        ...
        if(answer == JOptionPane.OK_OPTION){
            Upload upload = new Upload(this,true, Microwave, idUpload);
    ...
    private void BtnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAddActionPerformed
        ...
        try {
           ...
           // data.put("EnergySave", rbtEnergySave.getSelectedItem().toString());
           // data.put("Grill", rbtGrill.getSelectedItem().toString());
           // data.put("Status", cmbPotency.getSelectedItem().toString());
