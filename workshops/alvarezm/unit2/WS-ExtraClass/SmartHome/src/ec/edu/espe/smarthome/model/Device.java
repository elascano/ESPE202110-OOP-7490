...
public class Device {
    ...
    private String room;
    private boolean status;    // true -if the device is on, false -f the device is off
    private int workingData;   // tv, radio --> volume; microwave --> time; refirgerator --> temperature
