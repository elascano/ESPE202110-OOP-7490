...
public class SmartHome {
    public static void main(String[] args) {
        ...
        System.out.println("Device Descrition" + tvBox.getDescription());
        if(tvBox.isStatus()){
            status = "on";
        }else{
            status = "off";
        ...
        System.out.println("Device Room" + tvBox.getRoom());
...
/*public static void oldMain (){
    System.out.println("List of devices from my home in json format ");
        ...
        Device tvBox;
        tvBox = new Device (id, description, room, status, workingData);
 
        Gson gson;
        gson = new Gson();

        String jsonDevice= gson.toJson(tvBox);
        ...
        for(String deviceString : devices){
            System.out.println("tvBox String --> " + deviceString + " <--");
            devicesList.add(tvBox);
            tvBox = gson.fromJson(deviceString, Device.class);
            System.out.println("tvBox id -> " + tvBox.getId());
