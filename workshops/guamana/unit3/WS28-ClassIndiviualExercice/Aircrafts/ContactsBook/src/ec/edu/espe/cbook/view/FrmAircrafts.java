...
import ec.edu.espe.controller.Connection;
import ec.edu.espe.cbook.model.Find;
 ...
 * @author Angel Guaman
 */
public class FrmAircrafts extends javax.swing.JFrame {
    
    Calendar fecha_actual = new GregorianCalendar();
    MongoCollection<Document> Contact = new Connection().obtenerDB().getCollection("FindAircrafts");
    ...
    public FrmAircrafts() {
        ...
        tabla.addColumn("ID clound ");tabla.addColumn("ID");tabla.addColumn("Model");
        tabla.addColumn("Passagares");
       
        
        tabla.addColumn("Arrival");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Aircrafts - Angel Guaman");

        jLabel2.setText("Id:");

        jLabel3.setText("Model");

        jLabel4.setText("Passageres");
        ...
        btnListContacts.setText("List Aircrafts");
    ...
    private void btnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUploadActionPerformed
        ...
        if(answer == JOptionPane.OK_OPTION){
            Find upload = new Find(this,true, Contact, idUpload);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAircrafts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAircrafts().setVisible(true);
            }
        });
    }
    public void mostrar(){
