...
public class FrmCateringPlanner extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        itmEvents = new javax.swing.JCheckBoxMenuItem();
        itmReservation = new javax.swing.JCheckBoxMenuItem();
        ...
        jLabel1.setText("Cattering Planner");

        itmAbout.setText("Catering Planner");

        jCheckBoxMenuItem1.setSelected(true);
        jCheckBoxMenuItem1.setText("About");
        itmAbout.add(jCheckBoxMenuItem1);
        ...
        itmReservation.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R, java.awt.event.InputEvent.CTRL_DOWN_MASK));
        itmReservation.setSelected(true);
        itmReservation.setText("Reservation");
        itmReservation.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                itmReservationActionPerformed(evt);
            }
        });
        MnuNew.add(itmReservation);
    ...
    private void itmEventsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itmEventsActionPerformed
        FrmCateringPlanner frmEvents = new FrmCateringPlanner();
    ...
    private javax.swing.JCheckBoxMenuItem itmEvents;
    private javax.swing.JCheckBoxMenuItem itmExit;
    private javax.swing.JCheckBoxMenuItem itmReservation;
