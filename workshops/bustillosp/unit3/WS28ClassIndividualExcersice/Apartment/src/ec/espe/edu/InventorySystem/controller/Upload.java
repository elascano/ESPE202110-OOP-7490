...
//ESTA CLASE VA EN EL PAQUETE VIEW
...
public class Upload extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Update Apartment");
    ...
    private void btnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUploadActionPerformed
        ...
        dataUpload.put("SIZE", txtName.getText());
        dataUpload.put("CAPACITY", Integer.parseInt(txtQuantity.getText()));
        dataUpload.put("PRICE", txtPrice.getText());
        dataUpload.put("DATE", txtDate.getDate().toString());
        dataUpload.put("LOACTION", txtComments.getText());
