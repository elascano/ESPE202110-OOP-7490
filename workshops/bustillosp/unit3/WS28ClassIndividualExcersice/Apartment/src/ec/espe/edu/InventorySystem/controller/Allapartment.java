 ...
 * @author Bustillos
 */
//ESTA CLASE VA EN EL PAQUETE DE VIEW
...
import ec.edu.espe.InventorySystem.view.Apartment;
import ec.edu.espe.InventorySystem.view.Apartment;
import java.util.ArrayList;
import javax.swing.table.DefaultTableModel;
import org.bson.Document;

public class Allapartment extends javax.swing.JFrame {
 ...
 //       
    ...
    public Allapartment() {
        ...
        tabla.addColumn("ID CLOUD");tabla.addColumn("ID ");tabla.addColumn("SIZE");
        ;tabla.addColumn("CAPACITY");tabla.addColumn("PRICE");tabla.addColumn("DATE");
    ...
    private void initComponents() {
        ...
        jToggleButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/edu/espe/InventorySystem/icons/uploadtotheclouddarkinterfacesymbol_79755.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/edu/espe/InventorySystem/icons/salir_1.png"))); // NOI18N
...
//
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Apartment frmContacts = new Apartment();
...
public void view(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Allapartment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Allapartment().setVisible(true);
            }
        });
    }
