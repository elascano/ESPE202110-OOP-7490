 ...
 */
package ec.edu.espe.building.view;
 ...
 */
public class BuildingFind extends javax.swing.JFrame {

    /**
     * Creates new form BuildingFind
     */
    public BuildingFind() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Color", "Floors", "Country", "City"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        btnFind.setFont(new java.awt.Font("Showcard Gothic", 2, 18)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuildingFind.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuildingFind().setVisible(true);
            }
        });
    }
